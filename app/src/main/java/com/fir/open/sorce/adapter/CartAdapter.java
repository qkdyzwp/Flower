...
public class CartAdapter extends RecyclerView.Adapter<CartAdapter.ViewHolder>{
    ...
    public CartAdapter(List<String> strList, Context context){
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ViewHolder holder = new ViewHolder(inflater.inflate(R.layout.fragment_main_cart_item, parent,
                false));
        return holder;
    }
    ...
    static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            img= (ImageView) itemView.findViewById(R.id.main_shopping_cart_product_icon);
        }
    }
}
